    ...
    <div className="container mx-auto p-6 max-w-2xl text-center">
      ...
      {status === 'idle' && (
        <div className="bg-white p-6 rounded-xl shadow-lg border-2 border-gray-200">
          ...
          <div id="reader" className="max-w-md mx-auto border-4 border-blue-600 rounded-lg overflow-hidden bg-gray-50"></div>
        </div>
      )}
      ...
      {status === 'success' && (
        <div className="py-20 bg-green-100 border-4 border-green-600 rounded-xl">
      ...
      {status === 'error' && (
        <div className="py-20 bg-red-100 border-4 border-red-600 rounded-xl">
          <p className="text-6xl mb-4">❌</p>
